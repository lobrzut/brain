...
**Title:** Brain AI Hub  
**URL:** https://github.com/lobrzut/brain

```
Self-hosted personal AI platform: local LLM (Ollama), knowledge vault, semantic RAG, transcript distillation, knowledge graph. MCP integration for Claude Code, Cursor, VS Code. Windows portable edition + Linux homelab server with SSE gateway.
